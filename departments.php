                                      ...
                                      if (isConfirm) {                                      	
                                               ...
                                               $.ajax ({
                                                      ...
                                                      if(result=="ok"){
                                                                    swal({
                                                                        title: "Deleted!", 
                                                                        text: "Department has been deleted from the database.", 
                                                                        type: "success",
                                                                        closeOnConfirm: true,
                                                                        closeOnCancel: true,
...
$retrieve = mysqli_query($db,$sqluse);
 ...
 <div id="Taxreceipted" class="modal fade" role="dialog">
  ...
  <div class="input-group" style="margin-bottom:10px">
    ...
    <input id="text" type="number" class="form-control" required name="startpoint" >
  </div>
  <div class="input-group" style="margin-bottom:10px">
    <span class="input-group-addon">To</span>
   <input type="number" class="form-control" required name="endpoint" >
  </div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title" style="font-family: Times New Roman;color:#F0F0F0;"><center>
        EDIT DETAILS OF DEPARTMENT: <input style="border: none;background:#222d32" type="text" id="oldname" value="" readonly="readonly" />
      ...
      <div class="modal-body" >
        <center>
        	...
        	<form method="post" action="upload.php" enctype='multipart/form-data'>        		
        	      <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" required type="text" name="name" id='oldname'></span></p>
                <input type="hidden" name="page" id="staffid"/>                                                       	      		
      ...
      <div class="modal-footer">
        <input type="submit" class="btn btn-success" value="Reset" id="amendreceipt" name="deptedit"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
      </div>
      </div>
       </form>
      ...
      <div class="modal-body" >       	
      	<center> 
        		...
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Phone:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" required name="phone"></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" required type="password" readonly Value="12345" name="password"></span></p>
...
<?php   
		...
		<div id="page-wrapper"  >
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">REGISTERED DEPARTMENTS LIST</h4>
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM department ";
			       $retrieve = mysqli_query($db,$sqlmember);
				                    $count=0;
                     while($found = mysqli_fetch_array($retrieve))
	                 {
                    $id=$found['Id']; $deptname=$found['Name'];$dateReg=$found['dateReg'];
			                $count=$count+1; 
            ...
            echo"<tr>    <td>$count</td> 
                             ...
                             <td>$dateReg</td>
			                 <td>
			                   <a data-toggle='modal' data-id='$id' data-ie='$deptname'   data-if='$dateReg' class='open-Passwords btn  btn-info' title='edit department details' href='#dept'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
			                 </td>				                 
			                 <td>
			                   <a data-id='$id'  class='open-Delete btn  btn-danger' title='delete departmnents' ><span class='glyphicon glyphicon-trash' style='color:white;'></span></a>
			                 </td>			 
                             </tr>"; 
