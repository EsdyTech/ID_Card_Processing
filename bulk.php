				...
				$sqln ="SELECT * FROM Inorg ";
                   ...
                   if($numb!=0){
                            while($foundl = mysqli_fetch_array($rgetb))
										...
										echo"<center><img src='media/$pic'  width='70%' height='140px' alt=''></center>";	   
                               }
							else{
              ...
              <li class="treeview">
               ...
               <li class="treeview">
                ...
                <ul class="treeview-menu">
                  ...
                  <!-- <li><a data-toggle='modal' data-id='' href='viewDepartment.php' class='open-Initial2'><i class="fa fa-minus"></i>View Department</a></li> -->
                </ul>
              </li>   
              <li class="treeview">
