...
<body style="background-image:url('images/land2.jpg');">
<div role="navigation" class="navbar navbar-default navbar-static-top">
		  <!-- <img src='images/love.png' alt='Avatar'  width='70px' height='70px'/> -->
      <div class="container">
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">	<?php echo "<h1><font color='blue'>STUDENT ID CARD PROCESSING AND MANAGEMENT SYSTEM</font></h1>";?></a></li>           
          </ul>
	...
	<form class="form-login" action="login.php" method="post" id="login-form">
		<h2 class="form-login-heading" align="center">Administrator Login</h2><hr />
		<div id="error">
		</div>
