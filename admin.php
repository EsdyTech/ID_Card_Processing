...
$sqluser ="SELECT * FROM Administrator WHERE id='$userid' && Email='$useremail'";

$retrieved = mysqli_query($db,$sqluser);
    $found = mysqli_fetch_array($retrieved);
...
<?php if(isset($_SESSION['memberadded'])){?>
 <script type="text/javascript"> 
 	          $(document).ready(function(){
 	          	                             swal({title: "Successful!", text: "Added successfully!!.", type: "success"});
                                  });
              </script>
...
$(document).ready(function(){  
 		                           swal({title: "Successful!", text: "Details edited Successfully!!.", type: "success"});
      ...
      <div class="modal-body" >       	
      	<center> 
        		...
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Phone:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" required name="phone"></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Password:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" readonly required type="password" Value="12345" name="password"></span></p>
								...
								<div class="profile_img">	
									<span class="prfil-img">
										<?php   
												           	...
												           	echo"<img src='admin/images/$pic' height='50px' width='50px' alt=''>";	   
										?>
										 </span> 
									<div class="user-name" >
		...
		<div id="page-wrapper"  >
			...
			<div class="mid-content-top charts-grids">
				<div class="middle-content">
						<h4 class="title">REGISTERED STUDENTS LIST</h4>
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM Users ";
			       $retrieve = mysqli_query($db,$sqlmember);
	                 ...
	                 {
                    $id=$found['id']; $othername=$found['othername'];$firstname=$found['Firstname'];$surname=$found['Surname'];$level=$found['Level'];
            ...
            echo"<tr>       <td>$count</td> 
                       ...
                       <td>$date</td>
			                 ...
			                 <td>
			                   <a data-toggle='modal' data-id='$id' data-ie='$firstname'   data-if='$surname' data-ig='$othername' data-ih='$dept' data-ij='$matricno' data-ik='$level' class='open-Passwords btn  btn-info' title='edit user details' href='#Passwords'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
